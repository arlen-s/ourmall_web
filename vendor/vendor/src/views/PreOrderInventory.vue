        ...
        <el-col :span="24">
          <el-card>
            ...
            >
              ...
              <el-table-column :label="$t('mycustomer.仓库')" width="180">
                <template slot-scope="scope">{{scope.row.warehouse.name}}</template>
              </el-table-column>
              <el-table-column :label="$t('mycustomer.库存')" width="180">
                <template slot-scope="scope">{{scope.row.inventory}}</template>
              </el-table-column>
              <el-table-column prop="timeCreated" :label="$t('mycustomer.创建时间')"></el-table-column>
            </el-table>
          </el-card>
        </el-col>
      </el-row>
