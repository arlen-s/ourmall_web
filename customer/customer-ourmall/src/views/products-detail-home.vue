      ...
      this.$apiCall(
        ...
        (r) => {
          if (r.ErrorCode == 9999) {
            ...
            this.videoList =r.Data.Results.videoUrlJson ==null || r.Data.Results.videoUrlJson =='null'|| r.Data.Results.videoUrlJson =='' ? [] : JSON.parse(r.Data.Results.videoUrlJson)
            ...
            this. concatList = [ ...newListVideo,...newListImg]
