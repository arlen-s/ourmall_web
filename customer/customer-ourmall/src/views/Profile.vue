              ...
              style="margin:0 145px;flex-direction: column;align-items: flex-start;">
                <div class="d-flex" style="margin-bottom:36px">
                  ...
                  <div style="margin-bottom:36px">
                      <p><el-checkbox disabled v-model="checked1">Allow system notifhcations</el-checkbox></p>
                      <p><el-checkbox v-model="checked2">Allow Customer Services from {{$root.$children[0].pName.a}} staffs</el-checkbox></p>
                      <p><el-checkbox v-model="checked3">Allow Dropshipping News</el-checkbox></p>
                  </div>
              </div>
              </div>
            </el-card>
