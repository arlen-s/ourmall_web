...
export default {
  ...
  data(){
    return {
      ...
      pageTime: 0,
      tabsArr: [ //id => status
        {name: 'Waiting', routerName: 'WaitingImport', id: '1', },
        {name: 'Processing', routerName: 'inImport', id: '2', },
        {name: 'Completed', routerName: 'imported', id: '3',},
        {name: 'Failed', routerName: 'importFailure', id: '4',},
      ],
      activeName: 1,
      loadingImport: false,
      importUrl: '',
