<template>
  <div>
    <template v-if="tab.id == '1'">
      <el-alert
        title="You can import and manage your AliExpress / Amazon products here before publishing them to your Shopify store. You can publish a product to different stores and add multiple tags to each products."
        type="info"
        show-icon
    ...
    <div>
      <el-table
        ...
        ref="importListTable"
      >
        <el-table-column v-if="tab.id == '2'"  label="Status" align="center" width="70">
        ...
        <el-table-column label="Images" align="center" width="90">
          <template slot-scope="scope">
            <div class="img-wrap">
        ...
        <el-table-column label="Price" align="center">
          <el-table-column label="Supply unit price" width="140">
            <template slot-scope="scope">
              <div>
                {{showPrice(scope.row)}}
              </div>
          ...
          <el-table-column label="Your price" width="220">
            <template slot-scope="scope">
              <div>
                {{scope.row.yourPrice}}
              </div>
        ...
        <el-table-column v-if="tab.id == '4'" label="Fail reason" >
          <template slot-scope="scope">
